...
class CreatePresencesTable extends Migration
{
    ...
    public static function initializeViews()
    {
        ...
        DB::unprepared("CREATE OR REPLACE VIEW v_all_plannings_presences_durations AS SELECT student_id, SUM(course_duration) course_duration, SUM(assisting_duration) assisting_duration, SUM(non_assisting_duration) non_assisting_duration, SUM(assisting_duration_class) assisting_duration_class, SUM(assisting_duration_remote) assisting_duration_remote, schoolyear_id FROM `v_plannings_presences_duration` GROUP BY student_id, schoolyear_id");
    }
}
